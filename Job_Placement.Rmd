...
The gender coefficient has a positive value associated with being male and is statistically signficant with a p-value of less than 0.05. We can deduce that if a candidate is male, i.e., has a value of 1 for their gender variable, then their odds of being hired are $$e^{1.30837} \approx 3.7$$ times the odds of a being hired if they were female. Alternatively, we can say that a male candidate has 270% $$3.7 - 1 = 2.7$$ greater odds of being hired than a female candidate.
